        ...
        <div className="w-full gap-y-9 pt-3 pb-6 flex flex-col md:flex-row justify-evenly  px-4">
          ...
          <div className="w-full md:w-[68px]">
            ...
            <ul className="flex flex-col gap-4 font-medium">
              <li className="pt-1 cursor-pointer"><Link href="/">Home</Link></li>
              <li className="pt-1 cursor-pointer"><Link href="/shop">Shop</Link></li>
              <li className="pt-1 cursor-pointer"><Link href="/contact">Contact</Link></li>
            </ul>
          </div>
